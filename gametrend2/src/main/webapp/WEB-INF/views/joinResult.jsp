...
<body id="joinBgColor">
	...
	<main>
	  <div id="joinResultBox">
	    <div class="row">
	      <div id="leftBox" class="col-lg-6">
	        <div class="row text-center d-flex h-100">
	          <div class="justify-content-center align-self-center">
	            <a href="/">
	              <img src='/images/logo.png' class="col-8"></img>
	            </a>
	            <br>
	            <a id="btnGoLogin" class="btn btn-outline-primary col-8 my-4" href="/login">로그인</a>	          
	          </div>
	        </div>
	      </div>
	      <div id="rightBox" class="col-lg-6">
	        <div class="row text-center d-flex h-100">
	          <div class="justify-content-center align-self-center">
				  <c:if test="${ result == 1 }">
				    <div class="mb-3">
					  <svg xmlns="http://www.w3.org/2000/svg" width="90" height="90" fill="#5C27FE" class="bi bi-check2-circle" viewBox="0 0 16 16">
					    <path d="M2.5 8a5.5 5.5 0 0 1 8.25-4.764.5.5 0 0 0 .5-.866A6.5 6.5 0 1 0 14.5 8a.5.5 0 0 0-1 0 5.5 5.5 0 1 1-11 0z"/>
					    <path d="M15.354 3.354a.5.5 0 0 0-.708-.708L8 9.293 5.354 6.646a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l7-7z"/>
					  </svg>				    
				    </div>			
					<h2 class="my-2">회원 가입이 완료되었습니다.</h2>
					<p class="my-2">GameTrend는 국내 각 게임 플랫폼별 게임 순위 및 정보를 알려주는 서비스를 제공합니다.</p>
				  </c:if>
				  <c:if test="${ result == 0 }">
					<h3>회원가입 실패</h3>
				  </c:if>	          
