...
<body>
		...
		본 설명에서는 PC 와 콘솔 게임기에 치중해서 설명을 이어나간다. <br> 
		...
		게임기는 과거 많은 콘솔 게임기 개발사가 있었지만, 현재에는 Nintendo 와 Sony 와 MS 의 3사 경쟁 구도로 좁혀져있는 상황이다. <br> 
		...
		메인 하드웨어 출시 이후, 다른 하드웨어 기종으로 이식을 수행하는 경우에는, 멀티 플랫폼(다기종 하드웨어) 사양 게임 타이틀이 된다. <br> 

		과거에는 메인 하드웨어에만 출시하거나, 메인 하드웨어 출시 이후에 다른 하드웨어 기종으로 이식 출시를 하는게 보편적이였으나, <br> 
		요즘에는 출시 초기부터 멀티 플랫폼으로 개발을 시작하여 출시까지 이어지는 경우가 대부분이다. <br> 

		다만, 멀티 플랫폼 게임들 외에도, 여전히 메인 하드웨어 전용 타이틀들이 출시되고 있으며, <br> 
		이는 콘솔 게임기를 구매하게 하는 가장 큰 주요 원인 중 하나로 매김한다. <br> 

		즉, 특정 콘솔 게임기에서만 플레이 할 수 있는 게임들이 있기에, <br> 
		PC 에서 멀티 플랫폼 게임들을 할 수 있음에도 불구하고, 여전히 콘솔 게임기의 인기와 수요가 유지되어 왔다고 할 수 있다. <br> 

		*최근에는 이러한 독점작들의 경계가 더욱 흐릿하여 졌지만, 독점작 이외에도 편의성 등의 부가 이유들로 인하여, 한동안 콘솔 게임기의 명맥은 더 이어질 것으로 사료된다. <br> 

		또한, 각 플랫폼별로 출시되는 게임들은 특성에 차이가 있다. <br> 
		이는, 플랫폼 자체의 특성 및 게임 강국 일본과 미국의 여러 환경에 차이로부터 발생하는 결과들이다. <br> 

		아래에서 각 플랫폼별 세부 설명 및 특성에 대해서 다루겠다. <br> 
		<br><br><br>
